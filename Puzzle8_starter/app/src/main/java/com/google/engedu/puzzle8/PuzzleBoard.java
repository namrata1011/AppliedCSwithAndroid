...
/*
algo-
1. steps for each tile
2. prty acc to max distance (using max heap)
3. queue k acc.. neighbor() & swap

manhattan function:
Array<int> func = new array
temp = 1;
for (int i=0; i<NUM_TILES; i++) {
	for (int j=0; j<NT; j++) {
